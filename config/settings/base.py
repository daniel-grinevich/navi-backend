...
MIGRATION_MODULES = {"sites": "navi_backend.contrib.sites.migrations"}
...
CSRF_COOKIE_SECURE = False  # OK for local dev over HTTP
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "navi_backend.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "navi_backend.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "navi_backend.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "navi_backend.users.forms.UserSocialSignupForm"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Navi Backend API",
    "DESCRIPTION": "Documentation of API endpoints of Navi Backend",
    "VERSION": "1.0.0",
